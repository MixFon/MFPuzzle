...
enum Heuristic: String {
	...
	func getHeuristic(coordinats: [UInt8: BoardPoint], coordinatsTarget: [UInt8: BoardPoint]) -> Int {
		switch self {
		case .manhattan:
	...
	private func getDistance(coordinats: [UInt8: BoardPoint], coordinatsTarget: [UInt8: BoardPoint], distance: (BoardPoint, BoardPoint) -> Int) -> Int {
		var result = 0
